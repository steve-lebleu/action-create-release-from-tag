...
class GitService {
    ...
    static getLastTags(n) {
        return __awaiter(this, void 0, void 0, function* () {
            const tags = yield (0, child_process_promise_1.exec)('git tag -l --sort=-creatordate');
            (0, core_1.debug)(`${n} last tags are ${tags.stdout}`);
            if (!tags.stdout || tags.stdout === '') {
                (0, core_1.setFailed)('Tags cannot be retrieved');
            }
    ...
    static getCommits(tags) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, core_1.debug)(`Tags received in input ${tags}`);
            let command = '';
            switch (tags.length) {
                case 1:
            ...
            const messages = yield (0, child_process_promise_1.exec)(command);
            (0, core_1.debug)(`The commit messages are ${messages.stdout}`);
            if (!messages || !(messages === null || messages === void 0 ? void 0 : messages.stdout)) {
                (0, core_1.warning)(`No messages have been found`);
            }
